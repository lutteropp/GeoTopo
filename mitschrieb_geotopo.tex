...
\begin{center}
\includegraphics[width=0.3\textwidth]{images/Nullhomotopie.png}
\end{center}
\end{definition}
...
\begin{remark}
	...
	\begin{figure}[h]
		\centering
		\subfloat{\includegraphics[scale=0.3]{images/offener_Kreis.png}} $\qquad\qquad$ 				\subfloat{\includegraphics[scale=0.3]{images/offenes_Quadrat.png}} 
	\end{figure}
\end{remark}
...
\begin{remark}
	...
	\begin{figure}[h]
		\centering
		\subfloat{\includegraphics[scale=0.3]{images/Quadrate_Schnitt.png}}\qquad
		\subfloat{\includegraphics[scale=0.3]{images/Kreis_Schnitt.png}}
	\end{figure}
\end{remark}
...
\begin{bsp}{}
	$\R \times \R = \R^2$ \includegraphics[scale=0.06]{images/offener_Kreis.png}
...
\begin{definition}{Beschränktheit, Durchmesser}
	...
	\newline
	\begin{center}
	\includegraphics[width=0.3\textwidth]{images/Durchmesser.png}
	\end{center}
\end{definition}
...
\begin{remark}
	...
	\newline
	\begin{center}
	\includegraphics[width=0.3\textwidth]{images/metrisch_offen.png}
	\end{center}
\end{remark}
...
\begin{remark}
	...
	Ist $A \subset X$ \underline{offen} \underline{\underline{in $X$}}, so ist auch jede in $A$ offene Menge offen in $X$, und abgeschlossene\footnote{in $A$} Teilmengen einer in $X$ abgeschlossenen Menge $A$ sind auch abgeschlossen in $X$.
		...
		\begin{center}
	\includegraphics[width=0.3\textwidth]{images/offen_abgeschlossen.png}
	\end{center}
...
\begin{definition}{Innerer Punkt, äußerer Punkt, Randpunkt}
	...
	\end{enumerate}
		\begin{center}
	\includegraphics[width=0.3\textwidth]{images/innen_aussen.png}
	\end{center}
\end{definition}
...
\begin{center}
\includegraphics[width=0.4\textwidth]{images/stetig_in_x.png}
\end{center}
\end{definition}
...
\begin{definition}{Äquivalenz von Einbettungen}
	...
	\begin{center}
		\includegraphics[scale=0.3]{images/homotopieaequivalenz.png} 
	\end{center}
		kommutiert.
\end{definition}
...
\begin{bsp}{}
	Die Knoten mit Bildern \includegraphics[scale=0.3]{images/Knoten_Kreis.png} und \includegraphics[scale=0.3]{images/Knoten_aequivalent_zu_Kreis.png} sind äquivalent, die mit \includegraphics[scale=0.3]{images/Knoten_Kreis.png} und \includegraphics[scale=0.3]{images/Knoten_nicht_aequivalent_zu_Kreis.png} nicht!
\end{bsp}
...
\begin{center}
	\includegraphics[scale=0.3]{images/Ueberdeckung.png}
\end{center}	
...
\begin{definition}{Partition}
	...
	\begin{center}
		\includegraphics[scale=0.3]{images/Partition.png}
	\end{center}
\end{definition}
...
\begin{definition}{Weg, Anfangspunkt, Endpunkt}
	...
	\begin{center}
		\includegraphics[scale=0.3]{images/Weg.png}
	\end{center}
\end{definition}
...
\begin{center}
	\includegraphics[scale=0.3]{images/lokal_endlich.png}
\end{center} 
\end{definition}
...
\begin{definition}{Mannigfaltigkeit, Karte}
	...
	\end{enumerate}
	\begin{center}
	\includegraphics[scale=0.3]{images/Karte.png} 
	\end{center} 
\end{definition}
...
\begin{definition}{$C^k$-Atlas, Kartenwechsel}
	...
	\begin{center}
	\includegraphics[scale=0.3]{images/Kartenwechsel.png}
	\end{center} 
\end{definition}
...
\begin{definition}{$C^k$-Mannigfaltigkeit, glatt}
	...
	\newline
\end{definition}
\includegraphics[scale=0.3]{images/Verkleben.png}
\includegraphics[scale=0.3]{images/Verkleben_S2.png}
...
\newpage
\paragraph{Erinnerung} Jede Partition \includegraphics[scale=0.1]{images/Partition.png} $S$ einer Menge $X$ bestimmt eine Äquivalenzrelation auf $X$ (und umgekehrt).
\newline
