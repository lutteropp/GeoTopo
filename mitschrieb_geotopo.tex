...
\begin{bsp}{}
	\begin{itemize}
		\item $X = [0,1], \quad A = [\frac{1}{3}, \frac{2}{3}]$ (TODO: Bild)
	$$X/A \cong I = [0,1]$$
		\item $$ X = [0,1], A = \{\frac{1}{3}, 1\}$$ (TODO: Bild)
	$$\Rightarrow X/A \cong (TODO: Bild) \cong (TODO: Bild) \cong (TODO: Bild) \cong (TODO: Bild)$$
		\item $X = [0,1], A = \{0,1\} (TODO: Bild)$
			$$\Rightarrow X/A \cong (TODO:Bild) S^1$$
		...
		$$X/A = S^n (TODO: Bild)$$
		$$\overline{B^2}/_{S^1} = (TODO: Bild) S^2$$
...
\begin{bsp}{}
	\begin{itemize}
		...
		\item $I^2/_{[(0,t) \sim (1,t), \quad t \in I]} \cong (TODO: Bild) S^1 \times I$
		\newline (TODO: Bild)
	\end{itemize}
\end{bsp}
...
\begin{bsp}{}
$$S^1 \times I$$ (TODO:Bild)
$$S^1 \times I /_{[(z,0) \sim (z,1), z \in S^1]} \equiv (TODO:Bild)$$
$$(TODO:Bild:Quadrat) \leadsto (TODO:Bild:Zylinder) \leadsto (TODO: Bild:Torus) (TODO:Bild)$$
\end{bsp}

\begin{bsp}{}
	(TODO: Bild 20), d.h.: Betrachte $I^2/_{[(0,t) \sim (1,1-t)]}$ und verklebe also die gegenüberliegenden Kanten von $I^2$ in \underline{entgegengesetzter} Richtung $\leadsto$ Möbiusband (TODO: Bild 21)
\end{bsp}

\begin{bsp}{Die Kleinsche Flasche/ der Kleinsche Schlauch}
	$$K := I^2 /_{[(t,0) \sim (t,1), (0,t) \sim (1,1-t)]}$$
	(TODO: Bild 22) ist Quotient des Zylinders bzw. Möbiusbandes.
	\newline	
	(TODO: Bild 23)
\end{bsp}
