...
\begin{lemma}{}
	...
	\newline
	$U,V \cong \R^n$ (hier sind alle Wege homotop) $\Rightarrow \forall i \colon s \big |_{[a_i, a_{i+1}]} \sim$ Weg, der Teil eines Großkreises auf $S^n$ ist. (TODO: Bild 13) Für $n\geq 2$ füllt letzterer nicht $S^n$.
\end{proof}
\end{document}
