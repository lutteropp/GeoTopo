...
\begin{center}
	\includegraphics[scale=0.8]{images/jaenich_hausdorff.pdf}
\end{center}

\begin{center}
	\includegraphics[scale=0.5]{images/b2.pdf}
...
\begin{example}
	\begin{center}
		\includegraphics[scale=0.6]{images/b3.pdf}
	\end{center}
	...
	\end{enumerate}
	\begin{center}
		\includegraphics[scale=0.8]{images/b4.pdf}
	\end{center}
...
\begin{corollary}
	Eine geschlossen, zusammenhängende \underline{orientierbare} Fläche ist homöomorph zu einer zusammenhängenden Summe von Tori. (oder $S^2$!)
	\begin{center}
		\includegraphics[scale=0.8]{images/b5.pdf}
	\end{center}
\end{corollary}

	\begin{center}
		\includegraphics[scale=0.8]{images/b6.pdf}
	\end{center}
	...
	\begin{definition}{kombinatorische Unterteilung, Ecken, Kanten, Seiten}
		Eine kombinatorische \underline{Unterteilung} von $F$ ist eine Zerleckung von $F$ in
		\begin{enumerate}
			...
			\item \underline{Kanten} (endlich viele disjunkte Teilmengen von $F$, die alle zum offenen Intervall $(0,1)$ homöomorph sind)
				\begin{center}
					\includegraphics[scale=0.8]{images/b7.pdf}
			\end{center}
	...
	\begin{definition}{kombinatorische Euler-Charakteristik}
		Die (\underline{kombinatorische}) \underline{Euler-Charakteristik} einer gecshlossenen Fläche $F$ mit Unterteilung ist
...
\begin{example}
	\begin{center}
			\includegraphics[scale=0.8]{images/b8.pdf}
	\end{center}
\end{example}
...
\begin{remark}
	...
	\end{itemize}
	\begin{center}
		\includegraphics[scale=0.5]{images/2012_01_17_Bild1.png}
		\includegraphics[scale=0.5]{images/2012_01_17_Bild02.png}
	\end{center}
...
\begin{center}
	\includegraphics[scale=0.8]{images/2012_01_19_Bild1.pdf}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.5]{images/2012_01_19_Bild2.pdf}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.8]{images/2012_01_19_Bild3.pdf}
\end{center}

\begin{center}
	\includegraphics[scale=0.5]{images/2012_01_19_Bild4.pdf}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.5]{images/2012_01_19_Bild5.pdf}
\end{center}
...
\begin{example}
	\begin{center}
	\includegraphics[scale=0.5]{images/2012_01_19_Bild6.pdf}
	\end{center}
	$F = S^2 \subset \R^3$
...
\begin{example}
	\begin{center}
	\includegraphics[scale=0.5]{images/2012_01_19_Bild7.pdf}
	\end{center}
	Krümmung:
	\begin{itemize}
		\item	\textcolor{red}{$<0$}
