...
(TODO: Bild 1: Doppeltorus)
(TODO: Bild 2: 2-Sphäre homöomorph zu Tetraeder und zu Würfel)
\newline
...
\begin{example}
	$S^2, T^2$, (TODO: Bild 3 (Doppeltorus)) (TODO: Bild 4 ("Mehrfachtorus")) sind orientierbare geschlossene Flächen.
\end{example}
...
\begin{example}
	...
	\paragraph{Einfacher:}
	$\R \Prim^2 = $ (TODO: Bild 7) = (TODO: Bild 8)
...
\begin{example}
	$S^2 = $ (TODO: Bild 10) $\leadsto$ (TODO: Bild 11) $\leadsto a a^{-1} b b^{-1}$ 
\end{example}
...
\begin{example}
	$S^2 = $ (TODO: Bild 12) = $a a^{-1}$, $\R \Prim^2 = $ (TODO: Bild 13) $= aa$
\end{example}

Weitere wichtige Möglichkeit, neue Flächen zu gewinnen:

\begin{definition}{Zusammenhängende Summe}
	Es seien $F$ und $F^\prime$ geschlossene Flächen. Schneidet man aus jeder Fläche eine abgeschlossene Scheibe (TODO: Bild 14) heraus und identifiziert diese durch einen Homöomorphismus (TODO: Bild 15) der Ränder, so heißt der durch diese Identifikation entstehende Raum die \underline{zusammenhängende Summe} $F \# F^\prime$ von $F$ und $F^\prime$. \newline
	(TODO: Bild 16) 
\end{definition}
...
\end{example}
(TODO: Bild 17) (Fundamentalgruppe eines 2-Torus ist nicht mehr abelsch $\leadsto$ viel, viel größer)
